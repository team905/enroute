...
app.get('/Cozy-Himachal', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Cozy-Himachal', { pageTitle: 'Cozy-Himachal' });
});
app.get('/Swarg-Kedarnath', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Swarg-Kedarnath', { pageTitle: 'Swarg-Kedarnath' });
});
app.get('/Misty-Manali', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Misty-Manali', { pageTitle: 'Misty-Manali' });
});
app.get('/Enroute-Kashmir-Delights', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Enroute-Kashmir-Delights', { pageTitle: 'Enroute-Kashmir-Delights' });
});
app.get('/Enroute-Kashmir-Getaway', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Enroute-Kashmir-Getaway', { pageTitle: 'Enroute-Kashmir-Getaway' });
});
app.get('/Enroute-Kashmir-Jewels', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Enroute-Kashmir-Jewels', { pageTitle: 'Enroute-Kashmir-Jewels' });
});
app.get('/Enroute-Kashmir-Leisure-Delights', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Enroute-Kashmir-Leisure-Delights', { pageTitle: 'Enroute-Kashmir-Leisure-Delights' });
});
app.get('/Enroute-Kashmir-With-Vaishnodevi', (req, res) => {
  // Render the 'index.pug' template and pass data if needed
  res.render('Enroute-Kashmir-With-Vaishnodevi', { pageTitle: 'Enroute-Kashmir-With-Vaishnodevi' });
});
